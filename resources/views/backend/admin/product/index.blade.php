          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header d-flex">
                ...
                <span class="badge badge-success rounded-pill ml-2" style="font-size: 17px;"> {{ count($products) }} </span>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    @foreach($products as $key => $item)
                      <tr>
                        <td> {{ $key+1}} </td>
                        <td class="col-2">
                          <img src="{{ asset($item->product_image) }}" class="justify-content-center" width="80px" height="70px;" alt="No Image">
                        </td>
