                ...
                <div class="row m-4">
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" id="name" class="form-control" placeholder="Write page name">
                        @error('name')
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="title" value="{{ old('title') }}" id="title" class="form-control" placeholder="Write page title ">
                        @error('title')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                     </div>
