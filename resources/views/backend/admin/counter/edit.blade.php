                ...
                <div class="row m-4">
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="icon" value="{{ $counter->icon }}" id="icon" class="form-control" placeholder="Write service icon">
                        @error('icon')
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="title" title="title" value="{{ $counter->title }}" id="title" class="form-control" placeholder="Write service title">
                        @error('title')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                     </div>
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="number" name="counter_no" title="counter_no" value="{{ $counter->counter_no }}" id="counter_no" class="form-control" placeholder="Write counter no">
                        @error('counter_no')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                     </div>
