                ...
                <div class="row m-4">
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="title" value="{{ $notice->title }}" id="title" class="form-control" placeholder="Write title">
                        @error('title')
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                       ...
                       <input type="file" name="pdf" class="form-control" value="{{ $notice->pdf }}">
                     </div>
                  </div>
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <select name="notice_menus_id" id="notice_menus_id" class="form-control select2">
                           ...
                           @foreach ($notice_menu as $item)
                              <option value="{{ $item->id }}" @if ($notice->notice_menus_id == $item->id) selected @endif>{{ $item->name }}</option>
                           @endforeach
                        </select>
                     </div>
                  </div>
