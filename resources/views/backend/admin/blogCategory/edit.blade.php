            ...
            <div class="card-header">
               <div class="row">
                  ...
                  <div class="col-sm-6 text-right">
                     <a href="{{ route('blog.category.index') }}" class="btn btn-danger">
                ...
                <div class="row m-4">
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ $blogCategory->name }}" id="name" class="form-control" placeholder="Write blog category name">
                        @error('name')
