               ...
               <div class="row m-4">
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" id="name" class="form-control" placeholder="Write name">
                        @error('name')
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="designation" value="{{ old('designation') }}" id="designation" class="form-control" placeholder="Write designation">
                        @error('designation')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                     </div>
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="facebook_url" value="{{ old('facebook_url') }}" id="facebook_url" class="form-control" placeholder="Write facebook url">
                        @error('facebook_url')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                     </div>
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="linkedin_url" value="{{ old('linkedin_url') }}" id="linkedin_url" class="form-control" placeholder="Write linkedin url">
                        @error('linkedin_url')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                     </div>
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="twitter_url" value="{{ old('twitter_url') }}" id="twitter_url" class="form-control" placeholder="Write twitter url">
                        @error('twitter_url')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                     </div>
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" name="whatsapp_url" value="{{ old('whatsapp_url') }}" id="whatsapp_url" class="form-control" placeholder="Write whatsapp url">
                        @error('whatsapp_url')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                     </div>
